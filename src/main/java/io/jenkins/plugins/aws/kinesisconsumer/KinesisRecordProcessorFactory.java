...
/**
 * Factory to create {@link KinesisRecordProcessor} instances. The Kinesis Client Library will
 * instantiate {@link KinesisRecordProcessor} to process data records fetched from Kinesis.
 *

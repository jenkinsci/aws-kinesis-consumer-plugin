...
public class BaseLocalStack {
  ...
  private GlobalKinesisConfiguration initGlobalConfig(String streamName, String projectFieldName) {
    ...
    KinesisStreamItem kinesisStreamItem =
        new KinesisStreamItem(streamName, "TRIM_HORIZON", projectFieldName, true);

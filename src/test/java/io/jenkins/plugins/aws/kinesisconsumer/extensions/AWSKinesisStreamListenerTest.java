...
public class AWSKinesisStreamListenerTest {
  ...
  private static final Duration STREAM_CREATION_TIMEOUT = Duration.ofMinutes(1);
  private static final Duration TABLE_CREATION_TIMEOUT = Duration.ofMinutes(3);
  ...
  static int recordReceivedCounter = 0;
  ...
  public void shouldConsumeAnEventPublishedToAStream() throws Exception {
    ...
    WaitUtil.waitUntil(() -> recordReceivedCounter == 1, RECORD_CONSUMED_TIMEOUT);
  }
